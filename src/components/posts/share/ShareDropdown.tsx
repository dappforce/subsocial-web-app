...
import { facebookShareUrl, postUrl, twitterShareUrl, linkedInShareUrl, redditShareUrl } from 'src/components/urls';
...
const ShareMenu = (props: ShareMenuProps) => {
  ...
  return <Menu selectable={false}>
    <Menu.ItemGroup title="Share to:">
      ...
      <Menu.Item>
        <TwitterShareLink url={currentPostUrl} title={title} summary={summary} />
      </Menu.Item>
      <Menu.Item>
...
export const ShareDropdown = (props: ShareMenuProps) => {
  ...
  return <Dropdown trigger={[ 'click', 'hover' ]} overlay={<ShareMenu {...props} />}>
    <Button
      className={className}
